...
def test_count_orders_state(spark, expected_results):
    ...
    print("inside test_count_orders_state")
    print(actual_result.show(truncate=False))
...
@pytest.mark.skip
def test_pendingpayment_orders_count(spark):
...
def test_orders_count(spark, status, count):
